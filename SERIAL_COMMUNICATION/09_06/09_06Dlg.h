...
public:
	...
	int m_fileLength;			// FIleLength_Receiver
	BYTE m_WriteByte[SEND_DATA_LEN]{};
...
public:
	...
	CString GetFileName(CString m_strPathName); // 파일 절대 경로에서 파일 이름 구하기 (짜르기)
	CListCtrl m_List;
private:
